...
export const LotoGrid = ({ drawnNumbers, isDrawing, isBingoMode = false }: LotoGridProps) => {
  ...
  if (isBingoMode) {
    return (
      <div className="grid grid-cols-[auto_repeat(15,1fr)] gap-x-0.5 gap-y-2 px-12 py-6 bg-card/20 backdrop-blur-sm rounded-3xl border border-border/50 flex-shrink-0 items-center">
